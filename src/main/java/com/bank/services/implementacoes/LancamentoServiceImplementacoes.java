...
import com.bank.model.repositories.LancamentoRepository;
import com.bank.services.LancamentoService;
import com.bank.services.exceptions.RegraNegocioException;

@Service
public class LancamentoServiceImplementacoes implements LancamentoService {

	private LancamentoRepository repository;
	
	public LancamentoServiceImplementacoes(LancamentoRepository repository) {
		super();
